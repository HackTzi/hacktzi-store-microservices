...
import {
  CreateDepartmentDto,
  DepartmentDto,
  DepartmentWithCategoriesDto,
  getByIdParamDto,
  UpdateDepartmentDto,
} from './dtos/departmet.dto';
...
export class DepartmentController {
  ...
  @ApiResponse({
    status: 200,
    description: 'All departments with categories',
    type: DepartmentWithCategoriesDto,
    isArray: true,
  })
  @Get('/category')
  getDepartmentsAndCategories(): Promise<DepartmentDto[]> {
  ...
  @Get('/category/:id')
  getCategoryById(@Param() params: getByIdParamDto): Promise<CategoryDto> {
  ...
  @ApiResponse({
    status: 200,
    description: 'department with categories',
    type: DepartmentWithCategoriesDto,
  })
  @Get(':id/category')
  getDepartmentsAndCategoriesById(
    @Param() params: getByIdParamDto,
  ): Promise<DepartmentDto> {
